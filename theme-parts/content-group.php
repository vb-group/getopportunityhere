...
<div class="content_group_item">
			...
			<div class="header-info">
				<div class="title">
					...
					<div class="posts-action">
						...
						if (($posts_delete == "on" && $post_author == $user_id) || (isset($group_moderators) && is_array($group_moderators) && in_array($user_id,$group_moderators)) || $is_super_admin) {?>
	...
	<footer class="question-footer posts-footer">
		...
		if (is_user_logged_in() && ($is_super_admin || $post_author == $user_id || (is_array($group_moderators) && in_array($user_id,$group_moderators)))) {?>

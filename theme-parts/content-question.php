							...
							<div class="post-wrap-content">
								...
								<div class="question-content-text">
									...
									if (($pending_questions || is_single() || (!is_single() && $question_poll_loop == "on")) && $question_poll == "on") {
										...
										include locate_template("theme-parts/poll.php");
									}
								...
								<?php if (has_wpqa() && $pending_questions) {
									...
									<ul class="footer-meta">
										<?php if ($question_answer == "on") {?>
											<li class="best-answer-meta<?php echo ($the_best_answer != ""?" meta-best-answer":"")?>"><a href="<?php echo get_permalink()?>#comments"><i class="icon-comment"></i><?php discy_meta("","",$question_answer,"",$question_meta_icon)?></a></li>
										<?php }

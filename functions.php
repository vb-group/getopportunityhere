...
update_option('discy_ep_license_key', 'valid');
...
if (!function_exists('discy_body_classes')) {
	function discy_body_classes($classes) {
		...
		$classes[] = ($wp_page_template == "template-landing.php" || $under_construction == "on" || $site_users_only == "yes"?"discy_users_only main_users_only":"discy_for_all main_for_all");
	...
	function discy_scripts_styles() {
		...
		if ($site_width >= 1180) {
			$custom_css .= '@media (min-width: '.($site_width+30).'px) {
				...
				.discy-custom-width .main_center main.discy-main-wrap,.discy-custom-width .main_center main.all-main-wrap,
				.discy-custom-width .main_right main.discy-main-wrap,.discy-custom-width .main_right main.all-main-wrap,
				.discy-custom-width .main_full main.discy-main-wrap,.discy-custom-width .main_full main.all-main-wrap,
				.discy-custom-width .main_full .discy-main-inner,
				.discy-custom-width .main_full .hide-main-inner,
				.discy-custom-width .main_left main.discy-main-wrap,.discy-custom-width .main_left main.all-main-wrap {
					width: '.$site_width.'px;
				}
				.discy-custom-width main.discy-main-wrap,.discy-custom-width main.all-main-wrap,.discy-custom-width .menu_left .discy-main-inner,.discy-custom-width .menu_left .hide-main-inner {
				...
				.discy-custom-width.discy-left-sidebar .menu_sidebar main.discy-main-wrap,.discy-custom-width.discy-left-sidebar .menu_sidebar main.all-main-wrap,.discy-custom-width.discy-left-sidebar .menu_left .discy-main-inner,.discy-custom-width.discy-left-sidebar .menu_left .hide-main-inner,.discy-custom-width.discy-left-sidebar .menu_left main.discy-main-wrap,.discy-custom-width.discy-left-sidebar .menu_left main.all-main-wrap {
		...
		$custom_css .= '@font-face {
			font-family: "entypo";
			font-display: swap;
			src: url("'.get_template_directory_uri().'/css/entypo/entypo.woff2");
			font-weight: normal;
			font-style: normal;
		}';
...
function discy_backgrounds($custom_background = "",$background_type = "",$background_pattern = "",$background_color = "",$background_full = "") {
	...
	if ($background_type != "none") {
		if ($background_full == "on" && $background_type != "patterns" && $background_type != "") {
			$custom_css .= '.background-cover,.discy-content,.main-content {';
			...
			if ($background_type == "patterns" || !empty($custom_background)) {
				$custom_css .= 'body,.discy-content,.main-content {
					background:';
...
if (!function_exists('discy_meta')) {
	function discy_meta($date = "",$category = "",$comment = "",$asked = "",$icons = "",$views = "",$post_id = 0) {
		...
		if ( $comment == "on" && ! post_password_required() && ( comments_open() || $count_post_all > 0 ) ) {
			if ('question' === $post_type) {

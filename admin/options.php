...
function discy_admin_options() {
	...
	$options[] = array(
		'name' => esc_html__('Mobile settings','discy'),
		'id'   => 'mobile',
		'icon' => 'smartphone',
		'type' => 'heading'
	);
	...
	if (has_wpqa()) {
		...
		*/
		...
		$options[] = array(
			'name' => esc_html__('Enable or disable editor for details in ask question form','discy'),
	...
	$options[] = array(
		...
		'desc' => esc_html__('Select ON if you want to make the login to work without ajax to avoid the problems with the cache plugin.','discy'),
		'id'   => 'stop_login_ajax',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		...
		'desc' => esc_html__('Select ON if you want to make the register to work without ajax to avoid the problems with the cache plugin.','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Enable or disable editor for details in send message form','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Enable or disable the editor in the replies on comments/answers','discy'),

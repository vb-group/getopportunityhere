...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		 ...
		 * @var string
		 */
		protected $menu = 'install-plugins';
		 ...
		 * http://example.com/wp-admin/themes.php?page=install-plugins
		 *
		 * @since 2.5.0
		 *
		 ...
		 *
		 * I.e. depending on the config settings passed something along the lines of:
		 * http://example.com/wp-admin/themes.php?page=install-plugins&plugin_status=install
		 *
		 * @since 2.5.0
		 *
